    ...
    def build(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            enable_metric: Attach the GAUGE metrics ivshmem device in the template snapshot.
            config: SDK config.  Uses default (env-based) config if omitted.
        ...
        if enable_metric is not None:
            payload["enableMetric"] = enable_metric
